                ...
                <div className="privacy-consent-container">
                    ...
                    <div className="terms-box">
                        ...
                        * 사용자는 언제든지 개인정보 제공에 대한 동의를 철회할 수 있으며, 이 경우 서비스 이용이 제한될 수 있습니다.
                        ...
                        <p>
                        * 이 서비스를 이용하여 사용자가 올린 정보의 유출로 피해가 예상될 경우 가명, 다른 사이트에서 이용하지 않는 비밀번호를 사용하여 피해를 방지하세요. 사용자가 업로드하는 정보는 안전하게 보호되지만 강력한 공격에 의해 탈취되었을 경우 책임을 지지 않습니다. 
                        </p>
                        <p>
                        * 서비스의 종료, 데이터베이스 손실 등 정보의 손실로 인한 피해는 보상되지 않습니다. 중요한 정보는 반드시 백업해 주세요. 
                        </p>
                        <p>
                        * 누구도 불법적인 이미지, 문자, 링크 등의 content를 게시해서는 안됩니다. 게시하는 모든 content에 대한 책임은 본인에게 있습니다. 
                        </p>
                    </div>
                    ...
                    <div className="checkbox-container">
                        ...
                        개인정보 처리 규칙과 서비스 운영 방침을 모두 읽었으며, 이해하고 이에 동의합니다. 
                        </label>
                    </div>
                </div>
